...
s, fs = sound.load(r"C:\Users\pfmar\OneDrive\Escritorio\audiorois.wav")
s_filt = sound.select_bandwidth(s, fs, fcut=100, forder=3, ftype='highpass')

db_max=90  # used to define the range of the spectrogram
...
#Sxx_db_rmbg, _, _ = sound.remove_background_morpho(Sxx_db)



Sxx_db_smooth = sound.smooth(Sxx_db_rmbg, std=0.0)
